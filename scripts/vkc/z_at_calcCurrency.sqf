/*
	...
	z_at_calcCurrency.sqf originally from Zupas Advanced Trading
	Modified for gem support by icomrade for DayZ Epoch 1.0.6
	Modified for image/no image and font size support by salival
